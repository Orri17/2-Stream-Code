...
class spatial_dataset(Dataset):  
    ...
    def __getitem__(self, idx):
        ...
        if self.mode == 'train':
            ...
            clips = []
            clips.append(random.randint(1, math.floor(nb_clips/3)))
            clips.append(random.randint(math.floor(nb_clips/3), math.floor(nb_clips*2/3)))
            clips.append(random.randint(math.floor(nb_clips*2/3), math.floor(nb_clips+1)))
